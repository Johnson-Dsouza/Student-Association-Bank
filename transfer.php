<?php
    ...
    if (isset($_POST['submit'])) {
        $receipt_acc_num = $_POST['receipt_acc_num'];
        $amount = $_POST['amount'];
        ...
        if ($amount > $result['balance']) {
            ...
            $query1 = "UPDATE passbook SET balance = balance + $amount WHERE account_no = $receipt_acc_num";
             
            if(mysqli_query($db, $query1)){
            
                $query2 = "UPDATE passbook SET balance = balance - $amount WHERE account_no = '".$_SESSION["account_no"]."'";

                if (mysqli_query($db, $query2)) {
                    echo '<script>alert("Money Transferred Successfully");</script>';
                } 
                else {
                    echo '<script>alert("You do not have sufficient balance to transfer");</script>';
                }
            }
            else{
                echo '<script>alert("PLease Enter correct Receipient Account Number");</script>';
            }
        }
    }
                ...
                <form action="" method="POST">
                    <div class="form_wrap">
                        <div class="inp_grp">
                            ...
                            <div class="input_wrap">
                                <label for="receipt_acc_num">Receipient Account Number:</label>
                                <input type="number" id="receipt_acc_num" name="receipt_acc_num" placeholder="Holder Acount Number" required>
                            </div>
                            ...
                            <div class="input_wrap">
                                <input type="submit" name="submit" value="Transfer" class="submit_btn">
                            </div>
